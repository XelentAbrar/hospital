<template>
              ...
              <div class="mt-6 flow-root">
                  ...
                  <div class="pagination-container py-4 flex justify-between px-2">
                      <div class="pagination-info flex ">
                            Page <span class="font-semibold px-1 text-gray-900 report">{{ rooms.current_page }}</span> of
                              <span class="font-semibold px-1 text-gray-900 report">{{ rooms.last_page }}</span>
                            <div >
                              <p class="pagination-info">
                                Showing
                                <span class="font-semibold text-gray-900 report">{{ rooms.from }}</span>
                                to
                                <span class="font-semibold text-gray-900 report">{{ rooms.to }}</span>
                                of
                                <span class="font-semibold text-gray-900 report">{{ rooms.total }}</span>
                                entries
                              </p>
                            </div>
                          </div>
                      ...
                      <div class="pagination-boxes">
                            <template v-if="rooms.prev_page_url">
                                <InertiaLink
                                    :key="'prev'"
                            ...
                            <template v-for="page in rooms.last_page">
                                <InertiaLink
                                    :key="`page-${page}`"
                                    v-if="page === rooms.current_page"
                                    :href="
                                        route('rooms.index', {
                                            page: page,
                            ...
                            <template v-if="rooms.next_page_url">
                                <InertiaLink
                                    :key="'next'"
  ...
  const deleteRoom = (id) => {
    ...
    //   return Inertia.delete(route("rooms.destroy", id));
    // }
    Swal.fire({
        title: 'Are you sure?',
