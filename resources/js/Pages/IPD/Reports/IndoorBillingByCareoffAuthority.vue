    ...
    <div class="w-full mx-auto pt-6">
      <div class="bg-white overflow-hidden shadow-sm rounded-lg">
        <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          ...
          >
            <h1 class="font-semibold text-3xl text-primary">Indoor Billing By Careoff Authority</h1>
            <div class="mt-2 ml-auto sm:mt-0">
              <form
              @submit.prevent="report.get(route('ipd.reports-indoor-billing-by-careoff-authority'), report)"
            >
...
<p v-if="projectType === 'hms'">Nawaz Town Sargodha Road, Faisalabad</p>
              ...
              <div>
                  <p style="font-size: 22px;font-weight: 600;text-align: center;margin: 10px 0;">Indoor Billing By Careoff Authority</p>
              </div>
              ...
              <div class="table-wrap block table_height overflow-y-auto">
                  ...
                  <tbody>
                        ...
                        <td
                            class="whitespace-nowrap relative text-gray-900"
                        >
                            {{ formatNumber(+report?.advance_amount + +report?.received_amount + +report?.total_amount) }}
                        </td>
                        <td
                            class="whitespace-nowrap relative text-gray-900"
                        >
                  ...
                  <tfoot>
                    ...
                    >
                      ...
                      <td
                        class="whitespace-nowrap relative border-t border-gray-300"
                      >
                      {{ formatNumber(sum(reports, 'advance_amount') + sum(reports, 'received_amount') + sum(reports, 'total_amount')) }}
                      </td>
                      <td
                        class="whitespace-nowrap relative border-t border-gray-300"
                      >
