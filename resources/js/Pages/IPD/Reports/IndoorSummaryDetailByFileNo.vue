    ...
    <div class="w-full mx-auto pt-6">
      <div class="bg-white shadow-sm rounded-lg">
        <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          ...
          >
            <h1 class="font-semibold text-3xl text-primary">Indoor Summary Detail File No.</h1>
            <div class="mt-2 ml-auto sm:mt-0">
              <form
              @submit.prevent="filter.get(route('ipd.reports-indoor-summary-detail-by-file-no'), filter)"
            >
          ...
          <div class="mt-6 flow-root" id="printData">
            ...
            <div class="print-only">
              ...
              <div>
                  <p style="font-size: 22px;font-weight: 600;text-align: center;margin: 10px 0;">Indoor Summary Detail File No. - {{filter.file_no}}</p>
              </div>
            <div class="ring-1 ring-gray-300">
                  ...
                  <tbody>
                      ...
                      <tr
                        ...
                        v-if="report.advance_amount != null && report.advance_amount != ''"
                        >
                        <td
                        ...
                        <tr
                        class="divide-x divide-gray-300"
                        v-for="(detail, subIndex) in report.details"
                        :key="subIndex"
                        :class="subIndex % 2 === 0 ? 'bg-gray-50' : 'bg-white'"
                        >
                        <td
                            class="whitespace-nowrap relative border-b border-gray-300 text-gray-900"
                        >
                        ...
                        <td
                            class="whitespace-nowrap relative border-b border-gray-300 text-gray-900"
                        >
                            {{ formatNumber(detail?.service_amount) }}
                        </td>
                        <td
                            class="whitespace-nowrap relative border-b border-gray-300 text-gray-900"
                        >
                        ...
                        <td
                            class="whitespace-nowrap relative border-b border-gray-300 text-gray-900"
                        >
                            {{ formatNumber(detail?.doctor?.shares_type == 'Percentage' ? (detail?.service_amount * detail?.doctor?.shares)/100 : detail?.doctor?.shares) }}
                        </td>
                        <td
                            class="whitespace-nowrap relative border-b border-gray-300 text-gray-900"
                        >
                        ...
                        <tr
                        class="divide-x divide-gray-300"
                        v-if="report.careoff_id != null && report.careoff_id != ''"
                        >
                        <td
                            class="whitespace-nowrap relative border-b border-gray-300 text-gray-900"
                        >
                        {{ new Date(report?.admission_date).toLocaleDateString('en-GB').replace(/\//g, '-') }} {{ report?.admission_time }}
                        </td>
                        <td
                            class="whitespace-nowrap relative border-b border-gray-300 text-gray-900"
                        >
                        ...
                        <tr
                        class="divide-x divide-gray-300"
                        v-if="report.discount_amount != null && report.discount_amount != '' && report.discount_amount > 0"
                        >
                        <td
                            class="whitespace-nowrap relative border-b border-gray-300 text-gray-900"
                        >
                        ...
                        <tr
                        class="divide-x divide-gray-300"
                        v-if="report.zf_fee != null && report.zf_fee != '' && report.zf_fee > 0"
                        >
                        <td
                            class="whitespace-nowrap relative border-b border-gray-300 text-gray-900"
                        >
                  ...
                  <!-- <tfoot>
                    ...
                    >
                      <td
                        class="whitespace-nowrap relative border-b border-gray-300 text-center text-sm md:text-base"
                        colspan="2"
                      >
                        Total
                      </td>
                      <td
                        class="whitespace-nowrap relative border-b border-gray-300 text-sm md:text-base"
                      >
                      </td>
                      <td
                        class="whitespace-nowrap relative border-b border-gray-300 text-sm md:text-base"
...
const bedSum = (report, val) => {
  let days = 0;
    report.details.map(res1 => {
        days = +days + +res1.no_of_days
    })
    let days_charges = days * (report?.room?.charges ?? 0);
  return days_charges;
}
