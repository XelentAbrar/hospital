<template>
  <Head title="Admit Patient List" />
  <AppLayout title="Admit Patient List">
<div>
    <div class="py-4 px-4 mx-auto max-w-screen-xl lg:py-8">
        <div class="bg-blue-50 border border-gray-300 rounded-lg p-8 md:p-12 mb-4 shadow-md">
            <h1 class="text-gray-900 text-3xl md:text-4xl font-extrabold mb-2">Admit Patient List</h1>
            <form  @submit.prevent="report.get(route('ipd.reports-admit-patient-list'), report)">
