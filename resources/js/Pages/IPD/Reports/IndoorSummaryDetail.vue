    ...
    <div class="w-full mx-auto pt-6">
      <div class="bg-white shadow-sm rounded-lg">
        <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          ...
          >
            <h1 class="font-semibold text-3xl text-primary">Indoor Summary Detail</h1>
            <div class="mt-2 ml-auto sm:mt-0">
              <form
              @submit.prevent="filter.get(route('ipd.reports-indoor-summary-detail'), filter)"
            >
...
<p v-if="projectType === 'hms'">Nawaz Town Sargodha Road, Faisalabad</p>
              ...
              <div>
                  <p style="font-size: 22px;font-weight: 600;text-align: center;margin: 10px 0;">Indoor Summary Detail - Indoor</p>
              </div>
            <div class="ring-1 ring-gray-300">
                  ...
                  <tbody>
                      ...
                      <tr
                        ...
                        <td
                            class="whitespace-nowrap relative border-b border-gray-300 text-gray-900"
                        >
                        {{ formatNumber(detail?.doctor?.shares_type == 'Percentage'
                            ? (detail?.service_amount * detail?.doctor?.shares) / 100
                            : (detail?.doctor?.shares ?? 0))
                            || 0 }}
                        </td>
                        <td
                            class="whitespace-nowrap relative border-b border-gray-300 text-gray-900"
                  ...
                  <!-- <tfoot>
                    ...
                    >
                      <td
                        class="whitespace-nowrap relative border-b border-gray-300 text-center"
                        colspan="2"
                      >
                        Total
                      </td>
