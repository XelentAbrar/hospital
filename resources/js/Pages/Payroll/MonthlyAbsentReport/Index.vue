<template>
    <Head title="Monthly Absent Report" />
    <AppLayout title="Monthly Absent Report">
        <div class="py-4 px-4 mx-auto max-w-screen-xl lg:py-8">
            <div class="bg-blue-50 border border-gray-200 rounded-lg p-8 md:p-12 mb-8 shadow-md">
                ...
                <form @submit.prevent="form.get(route('monthly-absent-report.index'))" enctype="multipart/form-data">
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            ...
                            >
                                ...
                                >
                                    <ul>
                                        <li v-for="date in absentEmployee.absent_dates" :key="date">{{ new Date(date).toLocaleDateString('en-GB').replace(/\//g, '-') }}</li>
                                    </ul>
                                </td>
                            </tr>
                        </tbody>
