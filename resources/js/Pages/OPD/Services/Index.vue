    ...
    <div class="w-full mx-auto pt-6">
      <div class="bg-white overflow-hidden shadow-sm rounded-lg">
        <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          ...
          >
            <h1 class="font-semibold text-3xl text-primary">Services</h1>
            ...
            <div class="ring-1 ring-gray-200 sm:rounded-lg overflow-x-auto overflow-y-hidden">
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      >
                      <div class="flex items-center justify-center space-x-1.5 md:space-x-3 " v-if="role && role.role_id === 1 || role && role.role_id === 7">
                        <InertiaLink
              ...
              <div class="pagination-container py-4 flex justify-between px-1">
                      <div class="pagination-info flex ">
                            Page <span class="font-semibold px-1 text-gray-900 report">{{ services.current_page }}</span> of
                              <span class="font-semibold px-1 text-gray-900 report">{{ services.last_page }}</span>
                            <div >
                              <p class="pagination-info">
                                Showing
                                <span class="font-semibold text-gray-900 report">{{ services.from }}</span>
                                to
                                <span class="font-semibold text-gray-900 report">{{ services.to }}</span>
                                of
                                <span class="font-semibold text-gray-900 report">{{ services.total }}</span>
                                entries
                              </p>
                            </div>
                          </div>
                      ...
                      <div class="pagination-boxes">
                            <template v-if="services.prev_page_url">
                                <InertiaLink
                                    :key="'prev'"
                            ...
                            <template v-for="page in services.last_page">
                                <InertiaLink
                                    :key="`page-${page}`"
                                    v-if="page === services.current_page"
                                    :href="
                            ...
                            <template v-if="services.next_page_url">
                                <InertiaLink
                                    :key="'next'"
...
// //     return Inertia.delete(route("services.destroy", id));
// //   }
// Swal.fire({
//         title: 'Are you sure?',
