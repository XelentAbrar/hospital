<template>
  <Head title="Specialist Detail By Doctor" />
  <AppLayout title="Specialist Detail By Doctor">
    <div class="w-full mx-auto pt-6">
      <div class="bg-white shadow-sm rounded-lg">
        <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          ...
          >
            <h1 class="font-semibold text-3xl text-primary">Specialist Detail By Doctor</h1>
            <div class="mt-2 ml-auto sm:mt-0">
              <form
              @submit.prevent="report.get(route('opd.reports-specialist-detail-by-doctor'), report)"
            >
                ...
                <div>
                    ...
                    <div class="mt-2">
                      <input
                        ...
                        name="search"
                        type="text"
                        placeholder="search with doctor name"
...
<p v-if="projectType === 'hms'">Nawaz Town Sargodha Road, Faisalabad</p>
              ...
              <div>
                  <p
                      style="font-size: 24px;font-weight: 600;text-align: center;margin: 0;margin-bottom: 20px;margin-top: 20px;">Specialist Detail By Doctor</p>
              </div>
            </div>
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <!-- <td
                        class="whitespace-nowrap relative border-b border-gray-300 text-gray-900"
                      >
                        {{ formatNumber(report?.doctor?.shares) }}
                      </td> -->
...
const sum = (reports, val, type = null, check = null) => {
  ...
  reports.map(res => {
    if (type && type == 'appointment_details') {
      ...
      if (res.doctor && typeof res.doctor === 'object') {
        total = +total + +(res.doctor[val] || 0);
      }
    }
    else {
      if (res[check] != '' && res[check] != null) {
