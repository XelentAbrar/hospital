    ...
    <div class="w-full mx-auto pt-6">
      <div class="bg-white shadow-sm rounded-lg">
        <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          ...
          >
            <h1 class="font-semibold text-3xl text-primary">Consultant Tax Reports</h1>
            <div class="mt-2 ml-auto sm:mt-0">
              <form
              @submit.prevent="report.get(route('opd.reports-consultant-tax'), report)"
            >
          ...
          <div class="mt-6 flow-root" id="printData">
            ...
            <div class="print-only">
              ...
              <div>
                  <p
                      style="font-size: 24px;font-weight: 600;text-align: center;margin: 0;margin-bottom: 14px;margin-top: 14px;">Consultant Tax Reports</p>
              </div>
            </div>
            <div class="ring-1 ring-gray-300">
                  ...
                  <tbody>
                    ...
                    <tr class="divide-x divide-gray-300" v-if="report.appointments.length > 0">
                      <td
                        class="whitespace-nowrap text-center text-gray-900 bg-blue-200 border-y border-gray-300 sticky top-12 z-10"
                        colspan="9"
                      >
                        <span class="font-bold"> {{report?.name }}</span>
                      </td>
                    </tr>
                    <template v-for="(appointment, index) in report.appointments">
                        <tr
                        class="divide-x divide-gray-300"
                        v-for="(appointment_details, subIndex) in appointment.appointment_details"
                        :key="subIndex"
                        ...
                        >
                            ...
                            {{ new Date(appointment?.appointment_date).toLocaleDateString('en-GB').replace(/\//g, '-') }}
                        ...
                        <td
                            class="whitespace-nowrap relative border-b border-gray-300 text-gray-900"
                        >
                            {{ appointment?.careoff_id != '' && appointment?.careoff_id != null ? appointment?.careoff?.name : '' }}
                        </td>
                        <td
                            class="whitespace-nowrap relative border-b border-gray-300 text-gray-900"
                        >
                        ...
                        <tr
                          class="divide-x divide-gray-300 bg-secondary text-black font-semibold"
                        ...
                        >
                          ...
                          >
                            {{ formatNumber(sum(report.appointments, 'fee', 'appointment_details')) }}
                          </td>
                          <td
                            class="whitespace-nowrap relative"
                          >
