<template>
  <Head title="Detail By Amount" />
  <AppLayout title="Detail By Amount">
    <div class="w-full mx-auto pt-6">
      <div class="bg-white shadow-sm rounded-lg">
        <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          ...
          >
            <h1 class="font-semibold text-3xl text-primary">Detail By Amount</h1>
            <div class="mt-2 ml-auto sm:mt-0">
              <form
              @submit.prevent="report.get(route('opd.reports-detail-by-amount'), report)"
            >
...
<p v-if="projectType === 'hms'">Nawaz Town Sargodha Road, Faisalabad</p>
              ...
              <div
                  ...
                  <div style="width: 50%;">
                      <div style="display: flex;align-items: center;">
                          <h4 style="margin: 0;font-family: sans-serif; width: 100px;font-weight:600;font-size: 16px;">Amount</h4>
                          <h4 style="margin:0 10px;font-weight:bold; width: 10px;text-align: center;">:</h4>
                          <p style="margin: 0;margin-left: 2px;text-align: left;">{{selectedService && selectedService.name ? selectedService.name : 'All'}}</p>
                      </div>
                  </div>
              ...
              <div>
                  <p
                      style="font-size: 24px;font-weight: 600;text-align: center;margin: 0;margin-bottom: 20px;margin-top: 20px;">Detail By Amount</p>
              </div>
            </div>
