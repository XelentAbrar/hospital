<template>
  <Head title="Summary Detail By Date" />
  <AppLayout title="Summary Detail By Date">
    <div class="w-full mx-auto pt-6">
      <div class="bg-white shadow-sm rounded-lg">
        <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          ...
          >
            <h1 class="font-semibold text-3xl text-primary">Summary Detail By Date</h1>
            <div class="mt-2 ml-auto sm:mt-0">
              <form
              @submit.prevent="report.get(route('opd.reports-summary-detail-by-date'), report)"
            >
                ...
                <div>
                    ...
                    <div class="mt-2">
                      <input
                        ...
                        name="search"
                        type="text"
                        placeholder="search doctor and patient name"
...
<p v-if="projectType === 'hms'">Nawaz Town Sargodha Road, Faisalabad</p>
                  ...
                  <div style="width: 50%;display: flex;justify-content: start;">
                      <div style="display: flex;align-items: center;">
                          ...
                          <p style="margin: 0;margin-left: 2px;text-align: left;">
                            <!-- {{ new Date(to_date).toLocaleDateString('en-GB').replace(/\//g, '-') }} -->{{ report?.to_date }}
</p>
                      </div>
                  </div>
              </div>
              ...
              <div>
                  <p
                      style="font-size: 24px;font-weight: 600;text-align: center;margin: 0;margin-bottom: 20px;margin-top: 20px;">Summary Detail By Date</p>
              </div>
            </div>
...
// Update 'from_date' and convert to ISO format
const updateFromDateTime = () => {
  report.from_date = formatToISO(report.from_date);
};

// Update 'to_date' and convert to ISO format
const updateToDateTime = () => {
  report.to_date = formatToISO(report.to_date);
};
