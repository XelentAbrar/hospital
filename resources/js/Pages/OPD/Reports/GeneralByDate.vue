<template>
  <Head title="General By Date" />
  <AppLayout title="General By Date">
    <div class="w-full mx-auto pt-6">
      <div class="bg-white shadow-sm rounded-lg">
        <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          ...
          >
            <h1 class="font-semibold text-3xl text-primary">General By Date</h1>
            <div class="mt-2 ml-auto sm:mt-0">
              <form
              @submit.prevent="report.get(route('opd.reports-general-by-date'), report)"
            >
...
<p v-if="projectType === 'hms'">Nawaz Town Sargodha Road, Faisalabad</p>
                ...
                <div style="width: 50%;">
                      <div style="display: flex;align-items: center;">
                          ...
                          <p style="margin: 0;margin-left: 2px;text-align: left;font-weight: 500;">
                            {{ report?.from_date }}              <!-- {{ new Date(from_date).toLocaleDateString('en-GB').replace(/\//g, '-') }} -->
</p>
                      </div>
                  </div>
                  <div style="width: 50%;display: flex;justify-content: start;">
              ...
              <div>
                  <p
                      style="font-size: 24px;font-weight: 600;text-align: center;margin: 0;margin-bottom: 20px;margin-top: 20px;">General By Date</p>
              </div>
            </div>
    ...
    <tfoot>
        <tr class="divide-x divide-gray-300 bg-secondary text-black">
            ...
            <td> {{ formatNumber(data(reports, 'zf_fee', 'report')) }}
            </td>
            <td> {{ formatNumber(data(reports, 'donor_fee', 'report')) }}
            </td>
        </tr>
    </tfoot>
</table>
...
//       total = +total + +(res?.appointment_details[0]?.fee || 0);
//     }
//   });
//   return total;
// }
