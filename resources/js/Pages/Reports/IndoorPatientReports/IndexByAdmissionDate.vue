<template>
  <Head title="IPD report by Admission date" />
  <AppLayout title="IPD report by Admission date">
    <div class="py-4 px-4 mx-auto max-w-screen-xl lg:py-8">
        <div class="bg-blue-50 border border-gray-200 rounded-lg p-8 md:p-12 mb-8 shadow-md">
            <h1 class="text-gray-900 text-3xl md:text-4xl font-extrabold mb-2">IPD report by Admission date</h1>
            <form @submit.prevent="form.get(route('IPD-reports-by-admission-date.index'))" enctype="multipart/form-data">
                <div class="px-4 py-6 sm:p-8">
                    <label for="date" class="block text-lg font-semibold leading-6 text-gray-900">Admission Date</label>
                    <flat-pickr class="block cursor-pointer w-full rounded-md border-0 mt-2 py-2.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-200 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6" v-model="form.date" :config="dateConfig"></flat-pickr>
                </div>
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        ...
                        >
                          ...
                          <td
                            class="whitespace-nowrap relative border-b border-gray-300 text-gray-900"
                          >
                          {{ admission?.patient?.name ?? admission.name }}
