<template>
  <Head title="IPD report by File Number" />
  <AppLayout title="IPD report by File Number">
    <div class="py-4 px-4 mx-auto max-w-screen-xl lg:py-8">
        <div class="bg-blue-50 border border-gray-300 rounded-lg p-8 md:p-12 mb-8 shadow-md">
            <h1 class="text-gray-900 text-3xl md:text-4xl font-extrabold mb-2">IPD report by File Number</h1>
            <form @submit.prevent="form.get(route('IPD-reports-by-file-no.index'))" enctype="multipart/form-data">
