    ...
    <div class="w-full mx-auto pt-6">
      <div class="bg-white overflow-hidden shadow-sm rounded-lg">
        <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          ...
          >
            <h1 class="font-semibold text-3xl text-primary">Holidays</h1>
            <div class="mt-2 ml-auto sm:mt-0">
              <inertia-link
                ...
                >Create Holiday</inertia-link
              >
            </div>
          </div>
          <div class="mt-6 flow-root">
            <div
              class="shadow-md sm:rounded-lg overflow-x-auto overflow-y-hidden"
            >
              <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-100">
                  <tr>
                    ...
                    <th
                      scope="col"
                      class="whitespace-nowrap py-3.5 px-4 text-left text-base md:text-lg font-medium text-gray-800 max-w-96"
                    >
                      Notes
                    </th>
                    <th
               ...
               <tbody class="bg-white divide-y divide-gray-200">
                <tr class="hover:shadow-md transition-shadow duration-200"
                  ...
                  >
                    <td
                      class="py-3.5 px-4 whitespace-nowrap text-sm md:text-base"
                    >
                      {{ holiday.name }}
                    </td>
                    <td
                    ...
                    <td
                      class="py-3.5 px-4 max-w-96 text-sm md:text-base"
                    >
                      {{ holiday.notes }}
                    </td>
                    <td
                      class="py-3.5 px-4 relative whitespace-nowrap flex items-center justify-center space-x-1.5 md:space-x-3 text-right text-sm font-medium"
                    >
                      <InertiaLink
                        v-if="role && role.role_id === 1"
                      ...
                      <button
                        v-if="role && role.role_id === 1"
                        @click.prevent="deleteHoliday(holiday.id)"
                        type="button"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="pagination-container py-4 flex justify-between px-1">
              <div class="pagination-info flex">
                ...
                <div>
                  <p class="pagination-info">
                    Showing
                    <span class="font-semibold text-gray-900 report">{{
                      holidays.from
                    }}</span>
                    to
                    <span class="font-semibold text-gray-900 report">{{
              ...
              <div class="pagination-boxes">
                <template v-if="holidays.prev_page_url">
                  <InertiaLink
                    :key="'prev'"
                ...
                <template v-for="page in holidays.last_page">
                  <InertiaLink
                    :key="`page-${page}`"
                    v-if="page === holidays.current_page"
                    :href="
                ...
                <template v-if="holidays.next_page_url">
                  <InertiaLink
                    :key="'next'"
...
const deleteHoliday = (id) => {
  ...
  //     return Inertia.delete(route("holidays.destroy", id));
  //   }
  Swal.fire({
    title: "Are you sure?",
