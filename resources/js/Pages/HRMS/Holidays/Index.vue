            ...
            <div class="mt-6 flow-root">
                  ...
                  <table class="min-w-full border-separate border-spacing-0 divide-y divide-gray-200 overflow-auto">
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td
                          class="relative whitespace-nowrap flex items-center justify-center space-x-1.5 md:space-x-3 py-4 pr-4 pl-3 text-right text-sm font-medium sm:pr-8 lg:pr-8"
                        >
                ...
                <div class="pagination-container py-4 flex justify-between px-1">
                      <div class="pagination-info flex ">
                            Page <span class="font-semibold px-1 text-gray-900 report">{{ holidays.current_page }}</span> of
                              <span class="font-semibold px-1 text-gray-900 report">{{ holidays.last_page }}</span>
                            <div >
                              <p class="pagination-info">
                                Showing
                                <span class="font-semibold text-gray-900 report">{{ holidays.from }}</span>
                                to
                                <span class="font-semibold text-gray-900 report">{{ holidays.to }}</span>
                                of
                                <span class="font-semibold text-gray-900 report">{{ holidays.total }}</span>
                                entries
                              </p>
                            </div>
                          </div>
