            ...
            <form
              @submit.prevent="
                grade?.id
                  ...
                  : grade.post(route('grades.store'), grade)
              "
                ...
                >
                  <div class="">
                    ...
                    >
                      ...
                      />
                    <InputError
                      v-if="grade.errors?.name"
                      :message="grade.errors?.name"
                    />
                  </div>
                </div>
              <div
...
const grade = useForm({
  id: props?.grade?.id || null,
  name: props?.grade?.name || null,
});
</script>
